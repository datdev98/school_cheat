...
def login(username, password):
    username_input = browser.find_by_xpath(
        '//*[@id="cLogIn1_tb_cLogIn_User_I"]')[0]
    password_input = browser.find_by_xpath(
        '//*[@id="cLogIn1_tb_cLogIn_Pass_I"]')[0]
    login_button = browser.find_by_xpath(
        '//*[@id="cLogIn1_tb_cLogIn_Pass_I"]')[0]
...
def get_timetable(student_id):
    ...
    student_id_input = browser.find_by_xpath(
        '//*[@id="MainContent_Studentid_I"]')
